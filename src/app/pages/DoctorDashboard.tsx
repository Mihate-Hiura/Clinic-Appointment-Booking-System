        ...
        <div className="space-y-12">
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge variant="default">{upcomingAppointments.length} scheduled</Badge>
            </div>
                  ...
                  <div key={apt.id} className="bg-white rounded-lg border border-neutral-200 p-6">
                    ...
                    <div className="pt-4 border-t border-neutral-200">
                      <p className="text-sm text-neutral-600">
                        <span className="font-medium">Chief Complaint:</span> {apt.reason}
                      </p>
                    </div>
                  </div>
                ))
            ...
            <div className="space-y-4">
              {pastAppointments.length === 0 ? (
                ...
                pastAppointments.map(apt => (
                  <div key={apt.id} className="bg-white rounded-lg border border-neutral-200 p-6 opacity-75">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="font-semibold text-lg mb-1">{apt.customerName}</h3>
                        <p className="text-sm text-neutral-600">{apt.customerEmail}</p>
