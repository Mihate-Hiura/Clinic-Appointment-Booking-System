      ...
      <div className="w-full max-w-md px-6">
        ...
        {/* <div className="mt-12 p-4 bg-blue-50 rounded-lg text-sm text-neutral-700">
          ...
          <ul className="space-y-1 text-xs">
            <li>Customer1: customer1@clinic.com / Cus1123</li>
            <li>Customer2: customer2@clinic.com / Cus2123</li>
            <li>Receptionist1: receptionist1@clinic.com / Rec123</li>
            <li>Receptionist2: receptionist2@clinic.com / Rec2123</li>
            <li>Doctor1: doctor1@clinic.com / Doc1123</li>
            <li>Doctor2: doctor2@clinic.com / Doc2123</li>
